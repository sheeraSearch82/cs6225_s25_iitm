...
(* Welcome to 6.512!  Read through `Pset03Signature.v` before starting here. *)

Require Import Frap.
(* If this fails, do `make` in ../../frap directory *)

Require Import Pset03Signature.
(* If this fails, do `make` in this directory *)
...
(* The following line checks that your `Impl` module implements the right
   ...
   label … do not match`): *)
Module ImplCorrect : Pset03Signature.S := Impl.
